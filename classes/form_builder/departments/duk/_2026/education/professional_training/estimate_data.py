    ...
    },
    {
        ...
        "costs": [
            ...
            },
            {
                ...
                "name": "catering",
                "helpText": "Koszty nie mogą przekroczyć 15,00% ogólnej kwoty wnioskowanej. W przypadku uzyskania dofinansowania – nie mogą przekroczyć 15,00% przyznanej dotacji.",
                "overrides": {
                    "RequestedAmount": {
                        "validators": [
                            validators.related_fraction_gte_validator(
