    ...
    },
    {
        ...
        "costs": [
            ...
            },
            {
                "title": "Noclegi",
                "name": "accommodation",
                "helpText": "Koszty udokumentowane wyłącznie fakturami lub rachunkami (z wyłączeniem diet, ryczałtów i innych kosztów niewykazanych fakturą/rachunkiem). Z dotacji PISF nie są pokrywane koszty podróży zagranicznych, w tym zakwaterowania."
            },
            {
                "title": "Catering lub poczęstunek",
                "name": "catering",
                "helpText": "Koszty cateringu lub poczęstunku nie mogą przekroczyć 15,00% ogólnej kwoty wnioskowanej. W przypadku uzyskania dofinansowania nie mogą przekroczyć 15,00% przyznanej dotacji.",
                "overrides": {
                    "RequestedAmount": {
                        "validators": [
                            validators.related_fraction_gte_validator(
