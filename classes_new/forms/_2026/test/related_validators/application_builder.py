...
class RelatedValidatorsApplicationFormBuilder(ApplicationFormBuilder):
    ...
    def create_related_condition_ratio_validator(self, number: int):
        part = self.create_part(
            title=f"{self.helpers.int_to_roman(number)}. RelatedConditionRatioValidator",
            short_name=f"{self.helpers.int_to_roman(number)}. Related Condition Ratio Validator",
            chapters=[
                self.create_chapter(
                    components=[
                        self.create_component(
                        ...
                        self.create_chapter(
                            ...
                            components=[
                                self.create_component(
                                    component_type="text",
                                    mask="fund",
                                    name="conditionRatioMin",
                                    validators=[
                                        self.validator.related_condition_ratio_validator(
                                            field_name="conditionRatioTotal",
                                            conditions=[
                                                {
                                                    "field_name": "conditionRatioSelect",
                                                    "value": "Opcja 1",
                                                    "min_ratio": 10
                                                },
                                                {
